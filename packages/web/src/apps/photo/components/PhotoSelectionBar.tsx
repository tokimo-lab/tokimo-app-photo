...
export function PhotoSelectionBar({
  ...
  const bar = (
    <div className="pointer-events-none absolute inset-x-0 bottom-6 z-50 flex justify-center">
      <div className="pointer-events-auto flex items-center gap-3 rounded-2xl border border-[var(--glass-border)] bg-surface-glass px-5 py-3 shadow-2xl backdrop-blur-lg">
