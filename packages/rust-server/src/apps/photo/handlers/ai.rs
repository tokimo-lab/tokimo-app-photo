...
pub async fn ocr_scan(
    ...
    tokio::spawn(async move {
        match crate::apps::photo::services::photo_ocr::PhotoOcrService::ocr_app(&db, &st, app_id).await {
...
pub async fn ocr_search(
    ...
    let app_id = parse_uuid(&id)?;
    let results =
        crate::apps::photo::services::photo_ocr::PhotoOcrService::search_ocr_text(&state.db, app_id, &q.q)
            .await?;
...
pub async fn clip_embed(
    ...
    tokio::spawn(async move {
        match crate::apps::photo::services::photo_clip::PhotoClipService::embed_app(&db, &st, app_id, None)
            .await
        {
...
pub async fn clip_search(
    ...
    let app_id = parse_uuid(&id)?;
    let results =
        crate::apps::photo::services::photo_clip::PhotoClipService::search(&state.db, &state, app_id, &q.q)
            .await?;
    Ok(ok(serde_json::to_value(results).unwrap()))
}
...
pub async fn refresh_clip(
    ...
    crate::apps::photo::services::photo_clip::PhotoClipService::embed_photo(
        &state.db,
        &state,
        photo_id,
    )
...
pub async fn refresh_faces(
    ...
    let photo_id = parse_uuid(&id)?;
    let count = crate::apps::photo::services::photo_face::PhotoFaceService::detect_faces(
        &state.db,
        &state.ai,
        &state.sources,
        photo_id,
...
pub async fn refresh_ocr(
    ...
    let photo_id = parse_uuid(&id)?;
    let count = crate::apps::photo::services::photo_ocr::PhotoOcrService::ocr_photo(
        &state.db,
        &state,
        photo_id,
    )
...
pub async fn update_ocr_result(
    ...
    let updated = crate::apps::photo::services::photo_ocr::PhotoOcrService::update_ocr_result(
...
pub async fn delete_ocr_result(
    ...
    crate::apps::photo::services::photo_ocr::PhotoOcrService::delete_ocr_result(&state.db, ocr_id).await?;
...
pub async fn create_ocr_result(
    ...
    let created = crate::apps::photo::services::photo_ocr::PhotoOcrService::create_ocr_result(
