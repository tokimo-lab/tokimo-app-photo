...
use crate::db::models::photo::{PersonOutput, PhotoFaceOutput, PhotoOutput};
...
impl PhotoFaceService {
    ...
    pub async fn detect_faces(
        ...
        let image_bytes =
            crate::apps::photo::services::photo_ocr::load_photo_bytes(db, sources, &photo, image_path).await?;
