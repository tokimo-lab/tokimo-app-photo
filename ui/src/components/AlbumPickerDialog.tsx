      ...
      {showCreate ? (
        <div className="mt-3 flex items-center gap-2">
          <input
            ...
            className="min-w-0 flex-1 rounded-lg border border-black/[0.15] bg-transparent px-3 py-2 text-sm text-fg-primary outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:border-white/[0.15]"
            placeholder="相册名称"
            onKeyDown={(e) =>
        ...
        <button
          type="button"
          className="mt-3 flex w-full cursor-pointer items-center gap-2 rounded-lg p-2.5 text-sm text-fg-muted transition-colors hover:bg-black/[0.04] hover:text-fg-secondary dark:hover:bg-white/[0.06]"
