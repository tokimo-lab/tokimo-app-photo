let wasm_bindgen = (function(exports) {
     ...
     */
    function extractRawPreview(data) {
    ...
    exports.extractRawPreview = extractRawPreview;

    /**
     * @returns {string}
     */
    function wasmBuildTime() {
        let deferred1_0;
        let deferred1_1;
        try {
    ...
    exports.wasmBuildTime = wasmBuildTime;

    /**
     * @returns {string}
     */
    function wasmGitCommit() {
        let deferred1_0;
        let deferred1_1;
        try {
    ...
    exports.wasmGitCommit = wasmGitCommit;
